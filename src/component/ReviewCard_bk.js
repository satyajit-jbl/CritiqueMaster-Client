        ...
        <div className="card w-full max-w-sm bg-base-100 shadow-lg">
          <div className="card-body flex flex-col">
            ...
            <div className="card-actions justify-center gap-2 mt-4">
              <button onClick={() => setUpdateModal(true)} className="btn bg-yellow-400 w-full sm:w-auto">Update</button>
              <button onClick={() => deleteReviewMutaion.mutate(_id)} className="btn bg-red-400 w-full sm:w-auto">Delete</button>
            </div>
          </div>
        </div>
