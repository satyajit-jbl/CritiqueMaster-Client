    ...
    return (
        <div className="lg:flex justify-center items-center">
            <div>
                ...
                <motion.h2 
    className="text-4xl font-semibold text-center text-blue-600"
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
...
>
    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-title to-primary text-shadow-lg">
        Create Your Profile
                ...
                <Lottie animationData={registerLottieData} style={{ width: 400, height: 400 }}></Lottie>
            </div>
            <div className="card bg-base-100 w-full max-w-lg shrink-0 rounded-none p-5">
                ...
                <form onSubmit={handleSubmit} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <button className="btn bg-primary text-whiteContr text-xl rounded-xl">Register</button>
                    </div>
                </form>
